...
*Fig 1: Shows the Perceiver IO template: arbitrary inputs enter a latent workspace, then output queries decode task-specific structured outputs. | source: [Perceiver IO paper](https://arxiv.org/abs/2107.14795)*
...
*Fig 3: Multimodal audio-video-label autoencoding with 88x compression. Side-by-side: inputs on left, reconstructions right. | source: [Perceiver IO: A General Architecture for Structured Inputs & Outputs](https://arxiv.org/abs/2107.14795)*

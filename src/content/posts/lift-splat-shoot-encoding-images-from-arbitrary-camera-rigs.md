...
*Fig 1: Shows the contract LSS establishes: evidence from an arbitrary multi-camera rig lands in one vehicle-centered semantic map. | source: [Lift, Splat, Shoot](https://arxiv.org/abs/2008.05711)*

...
*Fig 1: The overview of the proposed Drive-R1, which comprises the supervised fine-tuning (SFT) and reinforcement fine-tuning (RFT) phases. | source: [Drive-R1: Bridging Reasoning and Planning in VLMs for Autonomous Driving with Reinforcement Learning](https://arxiv.org/abs/2506.18234)*

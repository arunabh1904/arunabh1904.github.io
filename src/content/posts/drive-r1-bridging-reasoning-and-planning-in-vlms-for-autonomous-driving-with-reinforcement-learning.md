...
_The overview of the proposed Drive-R1 , which comprises the supervised fine-tuning (SFT) and reinforcement fine-tuning (RFT) phases. Source: [Drive-R1: Bridging Reasoning and Planning in VLMs for Autonomous Driving with Reinforcement Learning](https://arxiv.org/abs/2506.18234), Figure 3, via arXiv HTML._

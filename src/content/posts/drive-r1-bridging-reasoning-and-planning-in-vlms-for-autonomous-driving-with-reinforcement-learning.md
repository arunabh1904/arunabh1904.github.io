...
*The overview of the proposed Drive-R1, which comprises the supervised fine-tuning (SFT) and reinforcement fine-tuning (RFT) phases. source: [Drive-R1: Bridging Reasoning and Planning in VLMs for Autonomous Driving with Reinforcement Learning](https://arxiv.org/abs/2506.18234)*
...
*Figure 1 Inference results with and without visual inputs from the model which is trained to predict trajectory without chain of thoughts. source: [Drive-R1: Bridging Reasoning and Planning in VLMs for Autonomous Driving with Reinforcement Learning](https://arxiv.org/abs/2506.18234)*

...
*Fig. 1: The paper contrasts vanilla all-view encoding, query-based compression, and the Vision MoE, then contrasts one averaged trajectory distribution with skill-routed behavior distributions. | source: [DriveMoE, Figure 1](https://arxiv.org/abs/2505.16278)*

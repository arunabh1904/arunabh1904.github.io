...
_History first sharpens the coarse satellite-grid distribution; only the retained candidates reach fine localization. Source: [Cross-View Sequential Visual Localization](https://arxiv.org/abs/2608.10660), Figure 2._

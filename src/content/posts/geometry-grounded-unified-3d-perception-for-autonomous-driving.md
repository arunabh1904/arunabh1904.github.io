...
*Fig 1: GeoUP combines image patches, raymaps, and camera tokens before decoding depth, boxes, and occupancy from one latent. | source: [GeoUP](https://arxiv.org/abs/2608.13147)*
...
*Fig 2: A conventional single-view recognition encoder learns semantic class cues but lacks explicit geometric structure and cross-view consistency. | source: [Geometry-Grounded Unified 3D Perception for Autonomous Driving](https://arxiv.org/abs/2608.13147)*

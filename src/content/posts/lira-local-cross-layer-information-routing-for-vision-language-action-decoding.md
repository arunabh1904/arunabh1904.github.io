...
_Each Parallel Fusion Block reads a depth-aligned local window of intermediate VLM features before action prediction. Source: [LIRA](https://arxiv.org/abs/2608.07596)._

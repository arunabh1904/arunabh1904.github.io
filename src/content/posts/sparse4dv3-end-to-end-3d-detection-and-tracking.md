...
*Fig 1: Denoising follows the same temporal path as deployed queries, so training exposes the decoder to errors that recurrent state can accumulate. | source: [Sparse4D v3](https://arxiv.org/abs/2311.11722)*
...
*Fig 2: Overview of Sparse4D framework, which input mutli-view video and output the perception results of all frames. | source: [Sparse4D v3: Advancing End-to-End 3D Detection and Tracking](https://arxiv.org/abs/2311.11722)*

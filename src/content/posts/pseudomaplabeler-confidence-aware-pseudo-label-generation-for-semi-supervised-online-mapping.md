...
*Fig 1: Overview of the proposed teacher-student semi-supervised learning framework. The teacher model is based on Uni-PrevPredMap (UPPM), which incorporates map prior rasterization and prior-based query initialization mechanisms. | source: [PseudoMapLabeler: Confidence-Aware Pseudo-Label Generation for Semi-Supervised Online Mapping](https://arxiv.org/abs/2608.12600)*
...
*Fig 2: Visualization of the confidence-aware map refinement process. Left: temporally accumulated map predictions across frames exhibit noise and duplication. | source: [PseudoMapLabeler: Confidence-Aware Pseudo-Label Generation for Semi-Supervised Online Mapping](https://arxiv.org/abs/2608.12600)*

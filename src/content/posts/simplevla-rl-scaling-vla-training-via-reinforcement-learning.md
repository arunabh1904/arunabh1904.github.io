...
*Fig 1: Shows where the additional signal comes from: the SFT policy interacts with the environment, produces groups of trajectories and rewards, and updates from relative advantages instead of remaining bounded by the offline demonstrations. | source: [SimpleVLA-RL](https://arxiv.org/abs/2509.09674)*
...
*Fig 3: Raising rollout temperature during reinforcement learning improves LIBERO-LONG success by about 15 percentage points and reaches the higher plateau earlier. | source: [SimpleVLA-RL: Scaling VLA Training via Reinforcement Learning](https://arxiv.org/abs/2509.09674)*

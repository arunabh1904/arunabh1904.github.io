...
*Fig 1: AutoTrust probes factuality, privacy, fairness, robustness, and safety with uncertainty questions, private-information prompts, adversarial attacks, and visual or language domain shifts. | source: [AutoTrust paper](https://arxiv.org/abs/2412.15206)*
...
*Fig 2: Scene Fairness Evaluation Results: Heat map of model performance (Accuracy %) across type and color of surrounding vehicles object. | source: [AutoTrust: Benchmarking Trustworthiness in Large Vision Language Models for Autonomous Driving](https://arxiv.org/abs/2412.15206)*

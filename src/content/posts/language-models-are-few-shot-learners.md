...
*Fig 1: GPT-3 performs tasks through text interaction alone: zero-shot uses an instruction, one-shot adds one example, and few-shot conditions on several demonstrations without gradient updates. | source: [GPT-3 paper](https://arxiv.org/abs/2005.14165)*
...
*Fig 2: 1: Language model meta-learning. During unsupervised pre-training, a language model develops a broad set of skills and pattern recognition abilities. | source: [Language Models are Few-Shot Learners](https://arxiv.org/abs/2005.14165)*



### Method and reported result

GPT-3 made scale itself feel like a new interface. It is a 175B-parameter autoregressive Transformer, roughly ten times larger than prior dense language models, trained on about 500B tokens of internet text. At test time, users can put a task description and a few examples in the prompt, and the frozen model often performs the task without gradient updates.

...
*Source Figure 1. LVIS has far fewer images per category than ImageNet and Conceptual Captions, motivating image-level supervision for vocabulary expansion. [Detic](https://arxiv.org/abs/2201.02605)*
...
*Source Figure 4. Prediction-based training jumps between blue candidate boxes and can select a region that misses the object; Detic's red max-size assignment is more stable and usually covers it. On an annotated IN-L subset, max-size covered 92.8% of target objects versus 69.0% for the prediction-based method. [Detic](https://arxiv.org/abs/2201.02605)*
...
*Source Figure 5. Qualitative 21K-class predictions on OpenImages and Objects365; purple labels are LVIS classes and green labels are novel classes. The examples show vocabulary transfer, not a claim that image labels supply precise boxes. [Detic](https://arxiv.org/abs/2201.02605)*
...
- On open-vocabulary LVIS, image-level co-training raises novel mask mAP from 16.3 to 24.6 with the default max-size loss, while the fully box-supervised reference is 25.5. The remaining gap is localization supervision.

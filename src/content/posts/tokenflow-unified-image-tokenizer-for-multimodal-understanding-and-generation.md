...
*Fig 1: Shows how TokenFlow keeps one discrete index useful for two jobs: semantic and pixel distances jointly select the code, while separate decoders preserve meaning and reconstruction detail. | source: [TokenFlow](https://arxiv.org/abs/2412.03069)*

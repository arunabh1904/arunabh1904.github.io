...
*Fig 1: Turns MM1 into an experimental recipe: hold the decoder-only LLM fixed while varying the visual encoder, connector, resolution, pretraining objective, and data mixture. | source: [MM1](https://arxiv.org/abs/2403.09611)*

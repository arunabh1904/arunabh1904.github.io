...
*Fig 1: Native-resolution inputs receive variable token budgets, while video position IDs encode absolute time before visual tokens reach the language decoder. | source: [Qwen2.5-VL](https://arxiv.org/abs/2502.13923)*

![Figure 1 from Qwen2.5-VL Technical Report](/assets/images/qwen2-5-vl-technical-report-source-figure-1.webp)
*Fig 2: The Qwen2.5-VL framework demonstrates the integration of a vision encoder and a language model decoder to process multimodal inputs, including images and videos. The vision encoder is designed to handle inputs at their native resolution and supports dynamic FPS sampling. | source: [Qwen2.5-VL Technical Report](https://arxiv.org/abs/2502.13923)*

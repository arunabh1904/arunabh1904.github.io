...
*Fig 1: Identifies Gigaflow's scaling unit: many agents act in tens of thousands of parallel worlds while sharing one policy, turning diverse interactions into one self-play training stream. | source: [Robust Autonomy Emerges from Self-Play](https://arxiv.org/abs/2502.03349)*
...
*Fig 2: A single Gigaflow policy trained entirely through self-play outperforms dataset-specific specialists across several benchmarks in zero-shot evaluation. | source: [Robust Autonomy Emerges from Self-Play](https://arxiv.org/abs/2502.03349)*
...
*Fig 3: As self-play training grows from millions to trillions of state transitions, the same policy progresses from failing benchmark scenarios to handling increasingly complex interactions zero-shot. | source: [Robust Autonomy Emerges from Self-Play](https://arxiv.org/abs/2502.03349)*

...
*Figure 2 identifies Gigaflow's scaling unit: many agents act in tens of thousands of parallel worlds while sharing one policy, turning diverse interactions into one self-play training stream. source: [Robust Autonomy Emerges from Self-Play](https://arxiv.org/abs/2502.03349)*

![Figure 1 from Robust Autonomy Emerges from Self-Play](/assets/images/robust-autonomy-emerges-from-self-play-source-figure-1.webp)
*Figure 1 Self-play reinforcement learning yields a generalist policy . a , A single Gigaflow agent outperforms the best dataset-specific specialists across leading benchmarks. Gigaflow is evaluated zero-shot without training on a single benchmark, while dataset-specific specialists train on benchmark-specific datasets. Each benchmark includes different maps, scenarios, and evaluation metrics. b , Gigaflow enables cost-effective training of policies via self-play on a massive scale. Our largest policies drive over 1. source: [Robust Autonomy Emerges from Self-Play](https://arxiv.org/abs/2502.03349)*

![Figure 3 from Robust Autonomy Emerges from Self-Play](/assets/images/robust-autonomy-emerges-from-self-play-source-figure-3.webp)
*Figure 3 Evolution of the policy during training. a , Zero-shot performance on example benchmark scenarios with increasing number of state transitions ( ) seen during training. From top to bottom: (3 million km), (90 million km), and (1600 million km). The color of the controlled vehicle and its trajectories indicate the benchmark score. b , Performance of the Gigaflow policy on a diagnostic scenario where a static obstruction (red bounding boxes) forces a merge of several highway lanes into one. source: [Robust Autonomy Emerges from Self-Play](https://arxiv.org/abs/2502.03349)*

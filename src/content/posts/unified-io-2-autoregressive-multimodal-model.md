...
*Fig 1: Unified-IO 2 architecture. Input text, images, audio, or image/audio history are encoded into sequences of embeddings which are concatenated and used as input to an encoder-decoder transformer model. | source: [Unified-IO 2: Scaling Autoregressive Multimodal Models](https://arxiv.org/abs/2312.17172)*
...
*Fig 2: Left: Training loss (a) and gradient norms (b) on different modality mixtures. Right: Training loss (c) and next token prediction accuracy (d) of UIO-2 on all modalities. | source: [Unified-IO 2: Scaling Autoregressive Multimodal Models](https://arxiv.org/abs/2312.17172)*

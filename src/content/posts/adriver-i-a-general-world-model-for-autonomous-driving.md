...
*Fig 2: ADriver-I interleaves historical visual and action tokens with the current visual token; the model predicts the next control and conditions future-frame generation on that action. | source: [ADriver-I: A General World Model for Autonomous Driving](https://arxiv.org/abs/2311.13549)*

...
*Figure 2 shows MPA3D: camera BEV features, LiDAR, surfels, and 3D Gaussian priors are encoded and gated before the SWFormer detector head. From the [Scene Reconstruction as Mapping Priors for 3D Detection paper](https://arxiv.org/abs/2605.22997). source: [Scene Reconstruction as Mapping Priors for 3D Detection paper](https://arxiv.org/abs/2605.22997)*

...
*Fig 2: Input format of evaluation on (1) phrase grounding and (2) referring expression comprehension. | source: [Kosmos-2: Grounding Multimodal Language Models to the World](https://arxiv.org/abs/2306.14824)*

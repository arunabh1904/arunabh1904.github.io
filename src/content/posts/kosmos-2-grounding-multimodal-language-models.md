...
On Flickr30K Entities, zero-shot KOSMOS-2 reaches test R@1/R@5/R@10 of 78.7/80.1/80.1, versus VisualBERT’s 71.3/85.0/86.5 with fine-tuning. The near-equality of KOSMOS-2’s top-1 and top-10 scores is an inference from the reported generation protocol; the paper defines R@k as recall among the top $k$ generated boxes and does not claim a causal explanation for that shape. Referring expression comprehension reaches RefCOCO val/testA/testB 52.32/57.42/47.26, RefCOCO+ val/testA/testB 50.73/45.48/42.24, and RefCOCOg val/test 60.57/61.65. RefCOCO+ removes spatial relations, while RefCOCOg contains longer expressions and spatial relations. The lower scores on the shorter game-generated RefCOCO and RefCOCO+ language show that grounding depends on the expression distribution, not only on box prediction.

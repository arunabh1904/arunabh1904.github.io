...
_Text, image, and combined views expose different bottlenecks. MIRROR selects the best teacher per problem rather than fixing one transfer direction. Cropped from Figure 1 of the [paper](https://arxiv.org/abs/2607.21552)._

...
**Context:** GKD makes distillation on-policy by training the student against teacher logits on prefixes generated by the current student.

**Limits:** It needs teacher access and substantial inference, inherits teacher errors, and assumes the initial student can visit useful states.

**Takeaway:** On-policy distillation is best understood as dense correction on the learner's own mistakes, not as another name for reinforcement learning.

...
*Across three tasks and student sizes, the on-policy variants deliver the largest gains over the initial student. The figure reports task-specific performance rather than claiming one divergence is universally best. source: [GKD](https://arxiv.org/abs/2306.13649)*
...
*Figure 3 Scaling training data . We evaluate distilled T5-small using temperature sampling ( ). GKD is more data efficient than baselines. source: [On-Policy Distillation of Language Models: GKD](https://arxiv.org/abs/2306.13649)*

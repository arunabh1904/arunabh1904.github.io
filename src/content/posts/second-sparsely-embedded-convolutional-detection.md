...
*Fig 1: SECOND spends 3D computation only on occupied voxels, then hands the resulting representation to a dense BEV proposal network. | source: [SECOND](https://doi.org/10.3390/s18103337)*

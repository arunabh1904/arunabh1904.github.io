...
*Fig 1: S4-Driver converts multi-frame images into volume features, combines them with ego-state text under multimodal attention, and decodes multiple trajectory candidates plus a meta-decision. | source: [S4-Driver: Scalable Self-Supervised Driving Multimodal Large Language Model with Spatio-Temporal Visual Representation](https://arxiv.org/abs/2505.24139)*
...
*Fig 2: Example input prompt and target output on WOMD-Planning-ADE. | source: [S4-Driver: Scalable Self-Supervised Driving Multimodal Large Language Model with Spatio-Temporal Visual Representation](https://arxiv.org/abs/2505.24139)*

...
_The predictor learns an eight-token future-motion latent; at inference, that latent retrieves logged trajectories for a scorer and drivable-area gate to select. Cropped from Figure 3 of the [paper](https://arxiv.org/abs/2607.29031)._

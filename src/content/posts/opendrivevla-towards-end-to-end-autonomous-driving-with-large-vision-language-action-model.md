...
OpenDriveVLA is a driving VLA built on open-source language models. It conditions action generation on camera-derived visual tokens, 3D structured perception, ego state, and language commands.

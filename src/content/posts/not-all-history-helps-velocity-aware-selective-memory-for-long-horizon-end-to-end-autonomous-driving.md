...
*Fig 1: Overall framework of StableDrive. StableDrive combines selective cross-cycle planning memory with a train-and-retire motion-stage scaffold. | source: [Not All History Helps: Velocity-Aware Selective Memory for Long-Horizon End-to-End Autonomous Driving](https://arxiv.org/abs/2608.15573)*
...
*Fig 2: In a nuScenes case, a stale motion prior makes MomAD diverge and collide, whereas StableDrive suppresses unreliable history and stays near ground truth; the accompanying metrics show lower long-horizon error and collision rate. | source: [Not All History Helps: Velocity-Aware Selective Memory for Long-Horizon End-to-End Autonomous Driving](https://arxiv.org/abs/2608.15573)*

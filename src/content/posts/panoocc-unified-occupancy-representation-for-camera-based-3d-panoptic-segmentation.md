...
*Fig 1: PanoOcc aligns and fuses temporal multi-view features into voxels, then decodes shared occupancy features into 3D detection and panoptic segmentation outputs. | source: [PanoOcc: Unified Occupancy Representation for Camera-Based 3D Panoptic Segmentation](https://arxiv.org/abs/2306.10013)*
...
*Fig 2: Illustration of occupancy sparsify. It serves as an optional technique to boost efficiency. | source: [PanoOcc: Unified Occupancy Representation for Camera-Based 3D Panoptic Segmentation](https://arxiv.org/abs/2306.10013)*

...
*Figure 1: Overall pre-training and fine-tuning procedures for BERT. From the [BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding paper](https://arxiv.org/abs/1810.04805). source: [BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding paper](https://arxiv.org/abs/1810.04805)*

![Figure 2 from >-](/assets/images/>--source-figure-2.webp)
*Figure 2 BERT input representation. The input embeddings are the sum of the token embeddings, the segmentation embeddings and the position embeddings. source: [>-](https://arxiv.org/abs/1810.04805)*

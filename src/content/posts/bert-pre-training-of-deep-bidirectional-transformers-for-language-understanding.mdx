...
*Fig 1: BERT pretrains a bidirectional Transformer encoder with masked-token and sentence-pair objectives, then fine-tunes the shared representation with lightweight task-specific heads. | source: [BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding paper](https://arxiv.org/abs/1810.04805)*

![Figure 2 from >-](/assets/images/>--source-figure-2.webp)
*Fig 2: BERT input representation. The input embeddings are the sum of the token embeddings, the segmentation embeddings and the position embeddings. | source: [BERT](https://arxiv.org/abs/1810.04805)*

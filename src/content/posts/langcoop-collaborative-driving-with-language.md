...
*Fig 1: Visualization of a natural-language-based collaborative driving scenario. CAV 2 slows down upon receiving the ‘slow down’ intent description from CAV 1. | source: [LangCoop: Collaborative Driving with Language](https://arxiv.org/abs/2504.13406)*
...
*Fig 2: Each vehicle converts observations into modular language descriptions, exchanges a compact LangPack with collaborators, and predicts trajectories plus control signals from the collected messages. | source: [LangCoop: Collaborative Driving with Language](https://arxiv.org/abs/2504.13406)*

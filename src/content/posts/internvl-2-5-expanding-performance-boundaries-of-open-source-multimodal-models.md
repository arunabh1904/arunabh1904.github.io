...
*Fig 1: Performance of various MLLMs on the OpenCompass leaderboard. | source: [InternVL 2.5: Expanding Performance Boundaries of Open-Source Multimodal Models paper](https://arxiv.org/abs/2412.05271)*
...
*Fig 2: Performance on LongVideoBench with varying input video frames. | source: [InternVL 2.5: Expanding Performance Boundaries of Open-Source Multimodal Models](https://arxiv.org/abs/2412.05271)*
...
*Fig 3: Dataset configuration. In InternVL 2.0 and 2.5, data augmentation is applied selectively, enabled for image datasets and disabled for videos and text. | source: [InternVL 2.5: Expanding Performance Boundaries of Open-Source Multimodal Models](https://arxiv.org/abs/2412.05271)*

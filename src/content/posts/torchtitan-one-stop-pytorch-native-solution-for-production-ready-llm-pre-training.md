...
TorchTitan is a PyTorch-native distributed training system for composing large-model training recipes. It brings modular 3D parallelism, elastic scaling, checkpointing, logging, debugging, Float8 training, and hardware-aware features into one system.

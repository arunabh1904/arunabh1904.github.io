...
**Context:** BEVDet4D carries one previous dense grid; sparse detectors carry instances; DriveWorld makes persistent 4D state itself the pretrained asset.

**Takeaway:** Temporal pretraining becomes more reusable when the memory distinguishes what should move, what should remain fixed, and which task is reading it.

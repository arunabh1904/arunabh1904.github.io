...
DriveMM is an academic generalist model for autonomous driving. It trains across multiple datasets and tasks, including perception, prediction, and planning, with a curriculum that moves from easier visual understanding toward harder planning behavior.

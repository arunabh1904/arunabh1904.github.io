...
*Fig 1: Navigational Commands. We show closed-loop results for different in-distribution and out-of-distribution commands. | source: [SimLingo: Vision-Only Closed-Loop Autonomous Driving with Language-Action Alignment](https://arxiv.org/abs/2503.09594)*
...
*Fig 2: SimLingo architecture. We encode the image, navigational conditioning and the language prompt. | source: [SimLingo: Vision-Only Closed-Loop Autonomous Driving with Language-Action Alignment](https://arxiv.org/abs/2503.09594)*

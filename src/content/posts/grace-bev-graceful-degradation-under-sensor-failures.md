...
**Context:** MetaBEV and UniBEV condition on modality availability; Grace-BEV makes estimated reliability part of the fusion interface.

**Takeaway:** Graceful degradation requires the model to represent sensor health, not merely notice that a tensor is absent.

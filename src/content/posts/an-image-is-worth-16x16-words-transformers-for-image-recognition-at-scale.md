...
*Fig 1: ViT splits an image into fixed-size patches, embeds them with position information and a class token, then applies a standard Transformer encoder before classification. | source: [An Image Is Worth 16×16 Words: Transformers for Image Recognition at Scale paper](https://arxiv.org/abs/2010.11929)*
...
*Fig 2: Breakdown of VTAB performance in Natural, Specialized, and Structured task groups. | source: [An Image Is Worth 16×16 Words: Transformers for Image Recognition at Scale](https://arxiv.org/abs/2010.11929)*
...
*Fig 3: Attention maps from the output token to input patches show that different heads attend to semantically relevant object regions across examples. | source: [An Image Is Worth 16×16 Words: Transformers for Image Recognition at Scale](https://arxiv.org/abs/2010.11929)*

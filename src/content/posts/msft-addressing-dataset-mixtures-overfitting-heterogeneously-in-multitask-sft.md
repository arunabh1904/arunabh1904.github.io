...
- The reported 63.7 average accuracy and the $C=1$ efficiency result are tied to the paper’s ten-task benchmark suite, validation protocol, and FLOPs accounting. They support the mechanism without proving that every mixture benefits.

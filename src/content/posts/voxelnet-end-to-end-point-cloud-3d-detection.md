...
**Context:** PointPillars collapses the voxel grid to columns for speed; SST and DSVT keep sparse high-resolution structure while expanding context.

**Takeaway:** Learned sensor encoding starts by choosing a physically meaningful neighborhood; unification should happen after that choice, not before it.

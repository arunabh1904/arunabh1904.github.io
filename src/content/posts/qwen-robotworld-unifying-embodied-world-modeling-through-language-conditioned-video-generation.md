...
*The model overview shows the shared transition interface: Qwen2.5-VL encodes the natural-language action, a VAE supplies video latents, and joint attention in every double-stream MMDiT block predicts the instructed future. source: [Qwen-RobotWorld](https://arxiv.org/abs/2606.17030)*

![Figure 8 from Qwen-RobotWorld: Unifying Embodied World Modeling through Language-Conditioned Video Generation](/assets/images/qwen-robotworld-unifying-embodied-world-modeling-through-language-conditioned-video-generation-source-figure-8.webp)
*Figure 8 RoboTwin-IF zero-shot qualitative cases. The benchmark is built on the RoboTwin simulator with newly constructed complex tasks. source: [Qwen-RobotWorld: Unifying Embodied World Modeling through Language-Conditioned Video Generation](https://arxiv.org/abs/2606.17030)*

![Figure 4 from Qwen-RobotWorld: Unifying Embodied World Modeling through Language-Conditioned Video Generation](/assets/images/qwen-robotworld-unifying-embodied-world-modeling-through-language-conditioned-video-generation-source-figure-4.webp)
*Figure 4 Scene2Robot: multi-segment conditioning for cross-embodiment video synthesis. The input sequence is organized as three contiguous segments — scene condition ( frames), robot reference ( frames), and generation ( frames). An index-based mechanism assigns condition tokens to timestep and excludes them from loss computation, so only the generation segment is trainable. source: [Qwen-RobotWorld: Unifying Embodied World Modeling through Language-Conditioned Video Generation](https://arxiv.org/abs/2606.17030)*

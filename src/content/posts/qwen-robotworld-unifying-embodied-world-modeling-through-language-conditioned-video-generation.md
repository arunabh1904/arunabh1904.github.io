...
*Fig 1: The model overview shows the shared transition interface: Qwen2.5-VL encodes the natural-language action, a VAE supplies video latents, and joint attention in every double-stream MMDiT block predicts the instructed future. | source: [Qwen-RobotWorld](https://arxiv.org/abs/2606.17030)*
...
*Fig 2: RoboTwin-IF zero-shot qualitative cases. The benchmark is built on the RoboTwin simulator with newly constructed complex tasks. | source: [Qwen-RobotWorld: Unifying Embodied World Modeling through Language-Conditioned Video Generation](https://arxiv.org/abs/2606.17030)*
...
*Fig 3: Scene2Robot: multi-segment conditioning for cross-embodiment video synthesis. The input sequence is organized as three contiguous segments — scene condition ( frames), robot reference ( frames), and generation ( frames). | source: [Qwen-RobotWorld: Unifying Embodied World Modeling through Language-Conditioned Video Generation](https://arxiv.org/abs/2606.17030)*

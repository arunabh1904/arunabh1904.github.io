...
*Fig 2: Diagram of the real and synthetic RM training setups. Human labellers generate comparison data. | source: [Scaling Laws for Reward Model Overoptimization](https://arxiv.org/abs/2210.10760)*
...
*Fig 3: RM validation loss vs BoN RM score @ n=1000. Most points in this figure are already averaged over multiple seeds. | source: [Scaling Laws for Reward Model Overoptimization](https://arxiv.org/abs/2210.10760)*

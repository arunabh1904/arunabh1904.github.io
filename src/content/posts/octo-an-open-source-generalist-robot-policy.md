...
*Fig 1: Shows Octo's adaptation interface: task and observation tokens share one transformer, while blockwise attention and readout tokens let fine-tuning add observations or action spaces without rewriting the pretrained backbone. | source: [Octo](https://arxiv.org/abs/2405.12213)*
...
*Fig 2: Model Scaling. The performance of Octo improves with larger model sizes on both UR5 and WidowX tasks. | source: [Octo: An Open-Source Generalist Robot Policy](https://arxiv.org/abs/2405.12213)*
...
*Fig 3: Evaluation Tasks. We evaluate Octo on 9 real robot setups across 4 institutions. | source: [Octo: An Open-Source Generalist Robot Policy](https://arxiv.org/abs/2405.12213)*

...
*Fig 1: DETR directly predicts (in parallel) the final set of detections by combining a common CNN with a transformer architecture. | source: [End-to-End Object Detection with Transformers](https://arxiv.org/abs/2005.12872)*
...
*Fig 2: Qualitative results for panoptic segmentation generated by DETR-R101. DETR produces aligned mask predictions in a unified manner for things and stuff. | source: [End-to-End Object Detection with Transformers](https://arxiv.org/abs/2005.12872)*
...
*Fig 3: Visualization of all box predictions on all images from COCO 2017 val set for 20 out of total prediction slots in DETR decoder. Each box prediction is represented as a point with the coordinates of its center in the 1-by-1 square normalized by each image size. | source: [End-to-End Object Detection with Transformers](https://arxiv.org/abs/2005.12872)*

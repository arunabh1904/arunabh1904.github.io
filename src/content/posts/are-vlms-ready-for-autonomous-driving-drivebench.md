...
DriveBench measures VLM reliability for autonomous driving through scene questions under clean-image, corrupted-image, and text-only conditions.
...
*Fig 1: DriveBench evaluates perception, prediction, behavior, and planning questions under 17 visual corruptions spanning content, context, and text-only inputs. | source: [DriveBench paper](https://arxiv.org/abs/2501.04003)*
...
*Fig 2: Do VLMs provide reliable explanations based on visual cues in driving? We study this from perspectives on reliability, data, and metrics. | source: [Are VLMs Ready for Autonomous Driving?](https://arxiv.org/abs/2501.04003)*
...
*Fig 3: Illustration of performance degradation. After applying each corruption, we evaluate the MCQs accuracy changes compared with clean inputs. | source: [Are VLMs Ready for Autonomous Driving?](https://arxiv.org/abs/2501.04003)*

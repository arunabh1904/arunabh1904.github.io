...
**Context:** LSS made depth a latent distribution; BEVDepth showed that explicitly supervising that latent can materially improve the camera-only detector.

**Takeaway:** A runtime sensor budget and a training supervision budget are different design variables.

...
_DAgger changes the training distribution by repeatedly labeling states induced by the current learner. Explanatory schematic based on Algorithm 3 in [Ross, Gordon, and Bagnell (2011)](https://proceedings.mlr.press/v15/ross11a.html)._

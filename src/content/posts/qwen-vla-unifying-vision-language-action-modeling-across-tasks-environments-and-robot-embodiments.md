...
*Fig 1: The Qwen-VLA overview shows the shared vision-language backbone feeding a DiT action decoder for manipulation, navigation, and trajectory tasks. | source: [official Qwen-VLA repository](https://github.com/QwenLM/Qwen-VLA)*
...
*Fig 3: Examples of data generated through RoboInF. The top row shows a short-horizon task, “Place the two green staplers side by side,” which consists of a compact sequence of reaching, grasping, transporting, and placing. | source: [Qwen-VLA: Unifying Vision-Language-Action Modeling across Tasks, Environments, and Robot Embodiments](https://arxiv.org/abs/2605.30280)*

...
UNITER pretrains on image-sentence pairs from COCO Captions, Visual Genome Dense Captions, Conceptual Captions, and SBU Captions. The in-domain COCO and Visual Genome data are cleaned to remove downstream evaluation images; the authors also use URL matching and exclude 109 images from training, with 222 more eliminated in the split construction. The out-of-domain Conceptual Captions and SBU mixture tests whether data that look less like the target images can substitute for in-domain pairs.

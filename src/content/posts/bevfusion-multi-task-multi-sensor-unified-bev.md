...
*Fig 1: BEVFusion's unification boundary is visible in the middle: modality-specific encoders end at BEV, after which the encoder and task interfaces are shared. | source: [BEVFusion](https://arxiv.org/abs/2205.13542)*
...
*Fig 2: BEVFusion unifies camera and LiDAR features in a shared BEV space instead of mapping one modality to the other. It preserves camera’s semantic density and LiDAR’s geometric structure. | source: [BEVFusion: Multi-Task Multi-Sensor Fusion with Unified Bird](https://arxiv.org/abs/2205.13542)*

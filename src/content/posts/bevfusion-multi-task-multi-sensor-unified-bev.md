...
_BEVFusion's unification boundary is visible in the middle: modality-specific encoders end at BEV, after which the encoder and task interfaces are shared. Source: [BEVFusion](https://arxiv.org/abs/2205.13542), Figure 2._

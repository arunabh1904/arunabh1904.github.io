...
*Fig 1: BEVFusion unifies camera and LiDAR features in a shared BEV space instead of mapping one modality into the other, preserving camera semantics and LiDAR geometry before fusion. | source: [BEVFusion: Multi-Task Multi-Sensor Fusion with Unified Bird](https://arxiv.org/abs/2205.13542)*
...
*Fig 2: Modality-specific encoders end at the shared BEV boundary; a common BEV encoder then feeds task-specific heads for map segmentation and 3D detection. | source: [BEVFusion: Multi-Task Multi-Sensor Fusion with Unified Bird](https://arxiv.org/abs/2205.13542)*

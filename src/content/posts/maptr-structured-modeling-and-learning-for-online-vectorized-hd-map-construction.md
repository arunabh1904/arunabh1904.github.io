...
*Fig 1: Shows the structured MapTR pipeline: sensor inputs become BEV features, hierarchical queries decode vector map elements, and matching handles point-level ambiguity. | source: [MapTR paper](https://arxiv.org/abs/2208.14437)*

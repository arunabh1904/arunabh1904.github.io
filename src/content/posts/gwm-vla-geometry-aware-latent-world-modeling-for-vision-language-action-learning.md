...
*Fig 1: Overall architecture of GWM-VLA. A frozen VGGT- encoder aggregates multi-view observations at each timestep. | source: [GWM-VLA: Geometry-Aware Latent World Modeling for Vision-Language-Action Learning](https://arxiv.org/abs/2608.07619)*

...
_The geometry-aware state conditions both target-view latent prediction and the flow-matching action head. Source: [GWM-VLA](https://arxiv.org/abs/2608.07619)._

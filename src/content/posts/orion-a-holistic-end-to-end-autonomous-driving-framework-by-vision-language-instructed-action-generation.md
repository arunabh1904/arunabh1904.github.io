...
*Fig 2: ORION uses a QT-Former to align long-term visual context with the language model, produces reasoning and a planning token, then conditions a generative planner that emits multimodal trajectories. | source: [ORION: A Holistic End-to-End Autonomous Driving Framework by Vision-Language Instructed Action Generation](https://arxiv.org/abs/2503.19755)*

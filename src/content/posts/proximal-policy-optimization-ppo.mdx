...
![PPO clipped surrogate objective for positive and negative advantages showing where probability-ratio gains flatten](/assets/images/proximal-policy-optimization-ppo-paper-figure.png)
_Figure 1 supplies the clipping intuition: once the probability ratio moves beyond the trusted band in the reward-improving direction, the surrogate stops paying for a larger update. Source: [PPO](https://arxiv.org/abs/1707.06347)._

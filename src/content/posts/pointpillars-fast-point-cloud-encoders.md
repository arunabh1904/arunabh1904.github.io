...
**Context:** VoxelNet learns features in 3D voxels; PointPillars makes an aggressive height-for-speed exchange that later BEV fusion systems often inherit.

**Takeaway:** Pillars are fast because they decide early that most downstream reasoning can live in BEV; that assumption should be task-tested rather than treated as free compression.

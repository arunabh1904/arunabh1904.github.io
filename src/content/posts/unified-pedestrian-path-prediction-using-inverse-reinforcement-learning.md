...
*Fig 1: The same social trajectory encoder can be trained under supervised, one-step, sequential, deterministic, or stochastic decision formulations; the paper studies the objective rather than replacing the perception backbone. | source: [Unified Pedestrian Path Prediction](https://arxiv.org/abs/2608.15929)*

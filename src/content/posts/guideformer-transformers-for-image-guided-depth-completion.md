...
**Context:** DeepLiDAR uses normals and confidence to structure completion; GuideFormer uses attention to increase the interaction range between RGB and depth.

**Takeaway:** Cross-modal attention can make sparse range evidence influence distant pixels, but it must justify that reach against its runtime and calibration cost.

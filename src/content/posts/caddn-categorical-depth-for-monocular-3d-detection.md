...
*Fig 1: CaDDN Architecture. The network is composed of three modules to generate 3D feature representations and one to perform 3D detection. | source: [CaDDN: Categorical Depth for Monocular 3D Detection](https://arxiv.org/abs/2103.01100)*

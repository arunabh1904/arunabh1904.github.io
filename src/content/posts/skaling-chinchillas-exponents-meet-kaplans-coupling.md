...
_The additive Chinchilla fit leaves a saddle-shaped residual at data-poor and overtrained corners; Skaling reduces that boundary pattern. The right panel reports the per-run MAPE ratio, not a new loss metric. Source: Figure 1 of the [Skaling paper](https://arxiv.org/abs/2608.07222)._

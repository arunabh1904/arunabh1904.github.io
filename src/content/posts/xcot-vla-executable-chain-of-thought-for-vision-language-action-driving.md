...
*Fig 1: Executable reasoning tokens and trajectory queries share multimodal context but use separate Reason and Control FFNs. | source: [XCoT-VLA](https://arxiv.org/abs/2608.10976)*

...
*Fig 1: Is the core scaling-law evidence: training loss improves predictably as total compute increases across the model family. | source: [Scaling Laws of Motion Forecasting and Planning paper](https://arxiv.org/abs/2506.08228)*

...
**Context:** RCBEVDet strengthens the radar representation before BEV fusion; CRN makes radar a guide for camera geometry.

**Takeaway:** Radar is most valuable when its range and motion evidence changes how camera features are localized, not when it is reduced to a generic feature map.

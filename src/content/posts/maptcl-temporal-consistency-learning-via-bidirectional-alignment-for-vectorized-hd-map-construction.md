...
*Fig 1: Overall pipeline of MapTCL. The pipeline takes multi-view images as input, encodes them into BEV features, and employs a map decoder to regress vectorized HD maps. | source: [MapTCL: Temporal Consistency Learning via Bidirectional Alignment for Vectorized HD Map Construction](https://arxiv.org/abs/2608.05209)*
...
*Fig 2: Qualitative comparisons on newsplit of nuScenes validation within perception range. StreamMapNet + MapTCL is compared with other baselines (StreamMapNet, SQD-MapNet, MapTracker ) and ground truth. | source: [MapTCL: Temporal Consistency Learning via Bidirectional Alignment for Vectorized HD Map Construction](https://arxiv.org/abs/2608.05209)*

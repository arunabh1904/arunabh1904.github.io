...
*Fig 1: Detection results from layer 1 to layer 5 in the DETR3D head. We visualize the bounding boxes in the BEV and overlay the point clouds from lidar_top. | source: [DETR3D: 3D Object Detection from Multi-View Images via 3D-to-2D Queries](https://arxiv.org/abs/2110.06922)*
...
*Fig 2: Overview of our method. The inputs to the model are a set of multi-view images, which are encoded by a ResNet and a FPN. | source: [DETR3D: 3D Object Detection from Multi-View Images via 3D-to-2D Queries](https://arxiv.org/abs/2110.06922)*

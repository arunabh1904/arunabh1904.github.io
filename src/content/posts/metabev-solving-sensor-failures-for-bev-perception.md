...
*Fig 1: MetaBEV makes sensor availability part of the computation path rather than silently replacing a failed modality with zeros. | source: [MetaBEV](https://arxiv.org/abs/2304.09801)*
...
*Fig 2: Map Segmentation results comparison under camera noises. We show the map segmentation mIoU ( left ) and the corresponding retention ( right ) under different weather, blur and digital conditions to show the zero-shot performance in the real-world environment. | source: [MetaBEV: Solving Sensor Failures for BEV Detection and Map Segmentation](https://arxiv.org/abs/2304.09801)*

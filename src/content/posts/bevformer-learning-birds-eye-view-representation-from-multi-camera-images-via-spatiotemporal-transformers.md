...
*Fig 1: Shows the BEVFormer encoder: camera features, BEV queries, spatial cross-attention, temporal self-attention, and detection/segmentation heads. | source: [BEVFormer paper](https://arxiv.org/abs/2203.17270)*
...
*Fig 2: On nuScenes visibility subsets, temporal information improves recall most for heavily occluded objects and also improves translation, orientation, and velocity accuracy. | source: [BEVFormer: Learning Bird](https://arxiv.org/abs/2203.17270)*

...
The animation below holds the mug-and-tray scene fixed and changes only the required output:

[![Animation comparing the outputs of CLIP, LLaVA, Molmo, and Pi0 on the same scene](/assets/images/blog-vlm-evidence-contract.gif)](/assets/images/blog-vlm-evidence-contract.gif)

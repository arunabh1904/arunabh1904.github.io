...
_Correct candidates accumulate faster than the deployed reducers can identify them. At 80 samples, even the better of plurality and reference-free pointwise selection remains 5.38–14.52 points below the candidate ceiling. Source: Figure 6 of [Test-Time Scaling in Reasoning LLMs](https://arxiv.org/abs/2608.04001)._

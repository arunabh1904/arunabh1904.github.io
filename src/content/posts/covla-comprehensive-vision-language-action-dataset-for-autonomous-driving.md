...
*Fig 1: Sampling reduces the dataset’s large near-zero-speed peak while preserving coverage across urban driving speeds, producing a more balanced control distribution. | source: [CoVLA: Comprehensive Vision-Language-Action Dataset for Autonomous Driving](https://arxiv.org/abs/2408.10845)*
...
*Fig 2: Overview of the dataset generation pipeline. We automatically label video frames and sensor signals to generate trajectories and other labels. | source: [CoVLA: Comprehensive Vision-Language-Action Dataset for Autonomous Driving](https://arxiv.org/abs/2408.10845)*

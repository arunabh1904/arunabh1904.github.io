...
*Fig 1: FSDrive pretrains by progressively generating future lanes, boxes, frames, and safe actions, then fine-tunes with spatio-temporal visual reasoning to produce scene descriptions and trajectories. | source: [FutureSightDrive: Thinking Visually with Spatio-Temporal CoT for Autonomous Driving](https://arxiv.org/abs/2505.17685)*

...
*Fig. 2: The three-stage framework first trains a text-guided video VAE, then trains a world model to predict action, visual, language, and future-latent tokens, and finally sends the predicted latent through joint attention to the action expert. | source: [HyWorldVLA, Figure 2](https://arxiv.org/abs/2607.20988)*

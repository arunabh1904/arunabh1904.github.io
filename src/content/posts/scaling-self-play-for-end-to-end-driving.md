...
*Fig 1: Isolates the three scaling stages: train a vector teacher with self-play RL, distill a pixel policy with self-play DAgger, then adapt only perception using paired simulated and real images. | source: [Scaling Self-Play for End-to-End Driving](https://arxiv.org/abs/2606.19641)*
...
*Fig 2: Agent simulation throughput falls as rendering resolution rises; Gigapixel rasterization sustains much higher steps per second than alternatives across render-only, CNN, and driver workloads. | source: [Scaling Self-Play for End-to-End Driving](https://arxiv.org/abs/2606.19641)*
...
*Fig 3: Pixel-based self-play DAgger improves driving score more quickly than self-play reinforcement learning, while both remain below the vectorized-teacher reference at the measured budgets. | source: [Scaling Self-Play for End-to-End Driving](https://arxiv.org/abs/2606.19641)*

...
*Fig 1: Shows the full LaneGCN pipeline: a lane graph and actor trajectories are encoded separately, fused through structured actor-map interactions, and decoded into future trajectories. | source: [LaneGCN paper](https://arxiv.org/abs/2007.13732)*
...
*Fig 2: Lane graph construction from vectorized map data. Left: The lane centerline of interest, its predecessor, successor, left and right neighbor are denoted with red, orange, blue, purple, and green lines, respectively. | source: [LaneGCN: Learning Lane Graph Representations for Motion Forecasting](https://arxiv.org/abs/2007.13732)*

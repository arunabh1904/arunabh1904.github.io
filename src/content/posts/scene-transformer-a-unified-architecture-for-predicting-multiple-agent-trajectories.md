...
*Fig 2: Joint prediction provides consistent motion prediction. Illustration of differences between marginal and joint motion prediction. | source: [Scene Transformer: A Unified Architecture for Predicting Multiple Agent Trajectories](https://arxiv.org/abs/2106.08417)*
